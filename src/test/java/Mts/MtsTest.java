...
public class MtsTest {
    ...
    @Description("Проверка placeholder в незаполненных полях услуги связи")
    public void checkCommunicationServiceEmptyFieldTest() {
        ...
        assertEquals(expectedPhoneNumberPlaceholder, phoneNumberText);
        ...
        assertEquals(expectedSumPlaceholder, sumFieldText);
        ...
        assertEquals(expectedEmailPlaceholder, emailText);
    }

    @Test
    @DisplayName("Проверка надписи в незаполненных полях Домашний интернет")
    @Description("Проверка placeholder в незаполненных полях  Домашний интернет")
    public void checkHomeInternetEmptyFieldTest() {
        ...
        String expectedEmailPlaceholder = "E-mail для отправки чека";
        assertEquals(expectedEmailPlaceholder, emailFieldText);
    }

    @Test
    @DisplayName("Проверка надписи в незаполненных полях рассрочка")
    @Description("Проверка placeholder в незаполненных полях  рассрочка")
    public void checkInstallmentEmptyFieldTest() {
        ...
        assertEquals(expectedAccountNumberPlaceholder, accountNumberText);
    ...
    @Description("Проверка placeholder в незаполненных полях  задолженность")
    ...
    @Description("Проверка заполнить поля услуги связи и окно после кнопки продолжить их placeholder," +
            "отображение суммы и номера,поля карты ")
    public void checkInputFormTest() {
        ...
        assertEquals(expectedSumInButtonText, sumInButtonText);
    ...
    private void checkCardInputFields() {
        ...
        assertEquals(expectedCardText, cardFieldText);
        ...
        assertEquals(expectedValidityText, validityText);
        ...
        assertEquals(expectedNameOwnerText, nameOwnerText);
    }
